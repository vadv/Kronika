...
pub enum RecoveryDamageReason {
    ...
    PartTooLarge,
    /// The complete frame body is not a fully valid canonical ZMS part.
    InvalidPart,
...
pub struct RecoveryScanReport {
    /// Complete verified ZMS part bodies, in physical journal order.
    pub parts: Vec<PartRef>,
    ...
    /// Total accepted ZMS part-body bytes.
