...
pub struct JournalRecoverySummary {
    ...
    /// Complete frames whose header, ZMS catalog, and all section CRCs verify.
    pub verified_frames: usize,
    /// Catalog row declarations across verified ZMS parts.
    pub verified_rows: u64,
    /// ZMS part-body bytes across verified frames.
