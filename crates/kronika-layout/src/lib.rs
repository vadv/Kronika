...
pub use root::{
    ...
    LOG_OFFSETS_TEMP_NAME, LayoutLimits, LayoutSnapshot, PathIdentity, SegmentArtifacts,
    SegmentRemoval, TemporaryKind, TemporaryObject, WRITER_OWNER_LOCK_NAME, WriterLease,
    WriterOwner, ZmsTemp,
};
