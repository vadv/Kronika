...
`SHA256SUMS` позволяет проверить каждый файл архива. Исполняемые файлы лежат
прямо в распакованном каталоге; команды ниже выполняются оттуда. Для хранения данных
...
версии. В исходном опубликованном архиве v1.0.0 ещё нет `kronika-dump slice`,
`kronika-report` и HTML-экспорта; эта инструкция относится к текущей упаковке.
