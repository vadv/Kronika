...
Нажмите занятую ячейку для перехода курсора к её концу, затем строку для
фильтрации таблицы. Таблица выбирает записанные снимки не позже этого времени. Команда может объединять много PID, включая уже
