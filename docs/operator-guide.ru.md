...
В Processes Activity нажмите занятую ячейку для перехода курсора к её концу,
затем строку для фильтрации таблицы. Таблица выбирает записанные снимки не позже этого времени. Команда может объединять много PID, включая уже
...
Для скриптов используйте [dump](../bins/kronika-dump/README.ru.md),
чтобы вырезать интервал, и [report](../bins/kronika-report/README.ru.md),
чтобы создать HTML.
