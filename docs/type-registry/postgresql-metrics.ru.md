...
pipelining. Большие результаты читаются пакетами не более 256 строк или по
оценке 512 KiB декодированных прикладных данных; пакет попадает в WAL до чтения
...
и записывается после первого успешного чтения, при изменении и при первом
добавлении строк PostgreSQL в новый сегмент.
