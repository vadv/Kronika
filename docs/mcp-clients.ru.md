...
- `kronika` — имя регистрации. Для нескольких инстансов Kronika дайте
  ...
  подключения в веб-интерфейсе выводит имя из крупнейшей записанной
  базы и эндпоинта, например `kronika-billing-192-168-0-22-8080`.
  Когда другая база перерастает текущую, производное имя меняется и
  повторный промпт добавит новую регистрацию — устаревшую запись
  удалите сами.
