...
Linux 6.17, an AMD Ryzen 9 8945HS, with an optimized build and a 100 Hz process
CPU clock. Reproduce them with:
...
Capture took 140 microseconds for the 120,000 repeated observations, 4
microseconds for 16 UIDs, and 1,002 microseconds at the 4,096-UID bound. Each
was below one 10 ms CPU clock tick. Production encoding, append, completion,
and read validation took 2,969, 645, and 4,429 microseconds respectively.

The optimized test process reached 15,584 KiB, 16,824 KiB, and 20,532 KiB for
...
below the collector's 25,600 KiB limit. Capture itself grew peak RSS by 384 KiB
