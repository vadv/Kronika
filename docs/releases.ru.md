...
При установленных `strace`, Node.js 22 и Chromium или Google Chrome:
...
используют `strace`, чтобы исключить обращение к хранилищу, запуск
логирования, потоков, процессов или сети перед выводом справки и версии.
