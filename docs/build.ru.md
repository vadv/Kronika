...
Для записи машины используйте переносимый архив. Сборка из исходников нужна
для работы над Kronika или конкретной ревизией. Репозиторий фиксирует
Rust **1.96.0** и зависимости. Web-интерфейс и движок отчётов хранятся как
готовые артефакты: обычной нативной сборке Node.js не нужен.
