...
**[Открыть интерактивное демо →](https://vadv.github.io/kronika-reports/reports/kronika-container-demo-20min-77c422e.html)**
Попробуйте такой HTML-отчёт на 20-минутной записи синтетической нагрузки Linux
и PostgreSQL. Установка и вход не нужны; сохраните файл, чтобы открыть его без сети.
