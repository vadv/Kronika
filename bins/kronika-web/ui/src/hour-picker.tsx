...
export function HourPicker({
  ...
  >
    ...
    <button
      ...
      className="flex h-[34px] min-w-[180px] cursor-pointer flex-col items-start justify-center border border-line3 bg-zebra px-2 text-left text-fg2 disabled:cursor-not-allowed disabled:opacity-45 max-[760px]:min-w-0"
