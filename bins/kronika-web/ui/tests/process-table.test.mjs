...
test("process summary charts preserve absent, null, zero, storage and human units", () => {
  ...
  assert.equal(helpers.processSummaryOutput(0.00399, metric("user_cores"), "en", t), "0.004 cores")
  ...
  assert.equal(helpers.processSummaryFormat(metric("user_cores"), t)(1.2304, "en"), "1.23 cores")
